const allImages = import.meta.glob('../assets/img/condition/**/*.jpg', { eager: true, import: 'default' });

export function getConditionImagePath(code, isDay = 1) {
  const condition = CONDITION_IMAGES.find((cond) => Number(cond.code) === Number(code));
  if (!condition) return allImages['../assets/img/condition/day/sunny.jpg'];
